...
It provides a app.service for your automation tests and a web ui for your manual tests.
...
If one app.service is temporarly unvailable or doesn't work properly, all of your test,<br>
